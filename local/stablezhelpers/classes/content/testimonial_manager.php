...
/**
 * Testimonial manager class for local_stablezhelpers plugin.
 *
...
require_once($CFG->dirroot . '/local/stablezhelpers/classes/form/testimonialcontent_edit_form.php');
...
class testimonial_manager {
    ...
    public static function delete(int $id): void {
        ...
        $testimonial = $DB->get_record('local_stablezhelpers_content', ['id' => $id, 'contenttype' => 'testimonial']);
        if (!$testimonial) {
        ...
        if (confirm_sesskey()) {
            ...
            redirect(new \moodle_url('/local/stablezhelpers/content/testimonial/index.php'));
        }
