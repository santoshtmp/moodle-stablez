...
namespace local_stablezhelpers\external\enrol;
 ...
 */
class user_course_list extends external_api {
     ...
     */
    public static function user_course_list_parameters() {
     ...
     * @return array
     */
    public static function user_course_list($userid, $courseid, $page, $perpage) {

        $params = self::validate_parameters(
            self::user_course_list_parameters(),
            [
                'userid' => $userid,
                'courseid' => $courseid,
                'page' => $page,
        ...
        $perpage = is_numeric($params['perpage']) ? (int)$params['perpage'] : 5;
     ...
     */
    public static function user_course_list_returns() {
