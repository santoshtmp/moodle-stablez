...
/**
 * Course get info external API for local_stablezhelpers plugin.
 *
 ...
 */
class course_info extends external_api {
     ...
     */
    public static function course_info_parameters() {
     ...
     * 
     */
    public static function course_info($courseids = [], $page = 0, $perpage = 10) {
        global $CFG, $DB;
        ...
        $params = self::validate_parameters(self::course_info_parameters(), [
            'courseids' => $courseids,
            'page' => $page,
            'perpage' => $perpage,
        ]);
        ...
        $filterparam = [
            ...
            'addactivitiescount' => false,
            'addcourseaccessusercount' => false,
            'addenrolinstances' => false,
            'addcoursegroups' => false,
            'addcustomnamevalueformat' => false,
     ...
     */
    public static function course_info_returns() {
