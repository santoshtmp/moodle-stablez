...
class user_service {
    ...
    public static function build_user_info($user, $filterparam = [], $additionaldata = []) {
        ...
        $userInfo = [
            ...
            'profileurl' => stablezhelpers::get_moodle_url('/user/profile.php', ['id' => $user->id], true, true),
            'gradereporturl' => stablezhelpers::get_moodle_url('/grade/report/overview/index.php', ['userid' => $user->id, 'id' => 1], true, true),
            'mycertificatesurl' => stablezhelpers::get_moodle_url('/mod/customcert/my_certificates.php', ['userid' => $user->id], true, true),
