        ...
        public function render_admin_page() { ?>
            <div class="wrap">
                ...
                <p>
                    ...
                    <a href="<?php echo esc_url($this->sso_helper->get_moodle_url() . '/local/stablezhelpers/login/sso.php'); ?>" target="_blank" class="button">
                        Test SSO Endpoint
                    </a>
                </p>
            </div>
...
if (!class_exists('MoodleSSO')) {
    ...
    class MoodleSSO {
        ...
        public function send_session_to_moodle($wp_user) {
            ...
            $response = wp_remote_post($this->get_moodle_url() . '/local/stablezhelpers/login/sso.php', [
                'method' => 'POST',
                'timeout' => 15,
        ...
        public function build_login_url($wp_user, $redirect_url = '') {
            ...
            $build_data['moodle_login_url'] = $this->get_moodle_url() . '/local/stablezhelpers/login/sso.php?' . http_build_query($params);
            return $build_data;
        }
        ...
        public function build_logout_url($wp_user, $redirect_url = '') {
            ...
            $build_data['status'] = true;
            $build_data['moodle_logout_url'] = $this->get_moodle_url() . '/local/stablezhelpers/login/sso.php?' . http_build_query($params);
            return $build_data;
        }
